...
## Overview
Volumetric PPI is a lidar data reconstruction approach to obtain volumetric wind field from plan position indicator (PPI) scanning long-range doppler wind lidar that mounted on the nacelle of a wind turbine where small nacelle oscillations results in large altitude variations of the scanned points. Typical PPI scan reconstruction yields planar wind field. This reconstruction approach take multiple scans from a 10 minutes window then derives wind field from multiple perspectives:
